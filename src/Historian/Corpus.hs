...
ethiopianWords =
  [ "makelaba", "tesharu", "zenawit", "abegazu", "haruken"
  , "dolvanu", "kedasha", "werabu", "lomeshu", "nadefan"
  , "chereku", "malkuta", "sebahle", "toregan", "wubante"
  , "kirasu", "damalu", "fenoteb", "harkuze", "selamun"
  , "gerimot", "yohanu", "tekleba", "worsanu", "abrahat"
  ]

southAsianWords :: [String]
southAsianWords =
  [ "chandravat", "suryaketu", "ravindanu", "devakiran", "priyantar"
  , "vasanthu", "indralok", "mahavira", "keshalan", "balaruna"
  , "tarashiv", "senaputra", "aranyaka", "nirmalesh", "kashyapan"
  , "vidyantar", "harishtra", "amarendu", "sudarshan", "vikramesh"
  , "lakshaven", "manohara", "ushanidra", "girijant"
  ]

semiticWords :: [String]
semiticWords =
  [ "karashim", "zahranu", "tammuzar", "nadikesh", "sulayfar"
  , "yazidane", "qadirun", "fahrizan", "zairuman", "hamalik"
  , "rashiddu", "tabaresh", "medanzar", "sharafin", "kadeshan"
  , "amirzuf", "baraket", "dahiruz", "nasirkan", "faridesh"
  , "malachim", "eliyazar", "shomarin", "tirzanek"
  ]

mesoamericanWords :: [String]
mesoamericanWords =
  [ "xochitepan", "cuauhtemal", "tlacayotl", "itzamahue", "nahuiteca"
  , "metzcoatl", "panohuitz", "tototlan", "chalcazin", "yaotecuh"
  , "coyolapan", "tlanextiz", "xolomitl", "cuetlaxan", "mictlazu"
  , "teponaztl", "xicotenca", "ahuizotan", "necahual", "tlalocan"
  , "quetzavan", "huitecalt", "moyotepec", "acamapiz"
  ]
...
baboonWords :: [String]
baboonWords =
  [ "oowahoo", "eehoowa", "ahoowee", "oohaeeoo", "waheeoo"
  , "eeohaah", "oohooee", "aeeohoo", "hooeewa", "oowaheea"
  , "eeoowah", "ahoeewa", "oohaeewa", "waeehoo", "eeahoowa"
  , "oohoowee", "aaheeoo", "wooeeha", "eehaoowa", "oowaheeoo"
  ]
...
societyNouns =
  ...
  , "Vigil", "Cenacle", "Fraternity", "Congregation", "Order", "Society"
  , "Otherhood", "Sisterhood", "Brotherhood"
  ]
...
siteNouns =
  ...
  , "Ruins", "Temple", "Tower", "Tor", "Mountain"
  , "Dungeon", "Bailey", "Barrio", "Library", "Hospital"
  ]

itemNouns :: [Text]
itemNouns =
  [ "Chalice", "Shroud", "Crown", "Blade", "Censer"
  , "Effigy", "Codex", "Mask", "Girdle", "Relic"
  , "Gloves", "Sword", "Dagger", "Axe", "Flail"
  , "Shield", "Hood", "Greaves", "Gauntlet", "Jerkin"
  , "Helm", "Mace", "Sceptre", "Bow", "Sling"
  , "Dragoon", "Lance", "Dakimakura"
  ]
...
itemEpithets :: [Text]
itemEpithets =
  [ "Bleeding", "Blackened", "Cracked", "Bound", "Whispering"
  , "Rusted", "Drowned", "Forgotten", "Anointed", "Splintered"
  ]
...
bynames :: [Text]
bynames =
  [ "the Younger", "the Elder", "the Fecund", "the Unmarred", "the Twice-Buried", "of the Low Choir"
  , "the Recanter", "the Blind", "the Unshriven", "the Handless", "the Wise"
  , "the Uncouth", "the Dark", "the Light", "the Grey", "the Homie", "One-Eye"
  ]
...
monthAdjectives =
  ...
  , "Fasting", "Nameless", "Shivering", "Glittering"
  ]
...
monthNouns =
  ...
  , "Serpent", "Ash", "Mouse", "Knife", "Man", "Woman", "Moon", "Sun", "Star"
  ]

monthEpithets :: [Text]
monthEpithets =
  [ "Turning", "Waning", "Ascendant", "Reversed"
  , "Unbound", "Drowning", "Silent", "Descending"
  ]
